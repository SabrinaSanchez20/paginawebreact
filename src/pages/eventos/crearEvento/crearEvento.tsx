...
const CrearEvento: React.FC = () => {
  ...
  const { createEvento } = useDataManager();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const eventoData = {
        ...
        imagen: formData.imagen || 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=500'
      };

      const success = await createEvento(eventoData);
      
      if (success) {
        setMensaje({ tipo: "success", texto: "¡Evento creado exitosamente!" });
        alertaCrear();
        ...
        setMensaje({ tipo: "danger", texto: "Error al crear el evento. Inténtalo de nuevo." });
      }
    } catch (error) {
        ...
        <div className="col-lg-8">
          ...
          <div className="d-flex align-items-center mb-4">
            ...
            <div>
              ...
              <p className="text-muted mb-0">Completa la información para crear un evento increíble</p>
            </div>
          </div>
